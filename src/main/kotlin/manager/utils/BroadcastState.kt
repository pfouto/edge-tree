...
class BroadcastState(val address: Inet4Address, val location: Manager.Location, val resources: Int, val state: Manager.State) {
    ...
    companion object {
        fun fromByteArray(bytes: ByteArray): BroadcastState {
            ...
            val location = Manager.Location(dis.readDouble(), dis.readDouble())
    ...
    fun toByteArray(): ByteArray {
        ...
        dos.writeDouble(location.x)
        dos.writeDouble(location.y)
